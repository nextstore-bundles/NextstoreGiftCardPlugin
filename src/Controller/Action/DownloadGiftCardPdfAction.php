...
use Nextstore\SyliusGiftCardPlugin\Security\GiftCardVoter;
...
final class DownloadGiftCardPdfAction
{
    ...
    public function __invoke(Request $request, int $id): Response
    {
        ...
        if (!$this->authChecker->isGranted(GiftCardVoter::READ, $giftCard)) {
            return $this->sendErrorResponse($request, $redirectUrl, 'nextstore_sylius_gift_card.gift_card.read_error');
        }
    ...
    private function getRedirectUrl(Request $request): string
    {
        ...
        return $this->urlGenerator->generate('nextstore_sylius_gift_card_admin_gift_card_index');
    }
}

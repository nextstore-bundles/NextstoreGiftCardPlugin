...
final class ResendGiftCardEmailAction
{
    ...
    public function __invoke(Request $request, int $id): Response
    {
        ...
        if (!$giftCard instanceof GiftCardInterface) {
            $this->addFlash($request, 'error', [
                'message' => 'nextstore_sylius_gift_card.gift_card.not_found',
                'parameters' => ['%id%' => $id],
            ]);
        ...
        if ($order instanceof OrderInterface) {
            ...
            $this->addFlash($request, 'success', [
                'message' => 'nextstore_sylius_gift_card.gift_card.resent',
                'parameters' => ['%id%' => $id],
            ]);
            ...
            $this->addFlash($request, 'error', [
                'message' => 'nextstore_sylius_gift_card.gift_card.impossible_to_resend_email',
                'parameters' => ['%id%' => $id],
            ]);
        }
    ...
    private function getRedirectUrl(Request $request): string
    {
        ...
        return $this->router->generate('nextstore_sylius_gift_card_admin_gift_card_index');
    }

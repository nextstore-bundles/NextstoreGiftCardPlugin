    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder->addEventListener(FormEvents::PRE_SET_DATA, function (FormEvent $event) use ($options): void {
            ...
            $form->add('amount', MoneyType::class, [
                'label' => 'nextstore_sylius_gift_card.form.add_to_cart.gift_card_information.amount',
        ...
        $builder->add('customMessage', TextareaType::class, [
            'required' => false,
            'label' => 'nextstore_sylius_gift_card.form.add_to_cart.gift_card_information.custom_message',
            'attr' => [
                'placeholder' => 'nextstore_sylius_gift_card.form.add_to_cart.gift_card_information.custom_message_placeholder',
            ],
        ]);
    }

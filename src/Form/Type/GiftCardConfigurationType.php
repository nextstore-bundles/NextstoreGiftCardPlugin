...
final class GiftCardConfigurationType extends AbstractResourceType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder->add('code', TextType::class, [
            'label' => 'nextstore_sylius_gift_card.form.gift_card_configuration.code',
        ]);
        $builder->add('enabled', CheckboxType::class, [
            'label' => 'nextstore_sylius_gift_card.form.gift_card_configuration.enabled',
            'required' => false,
        ]);
        $builder->add('default', CheckboxType::class, [
            'label' => 'nextstore_sylius_gift_card.form.gift_card_configuration.default',
            'required' => false,
        ]);
        $builder->add('backgroundImage', GiftCardConfigurationImageType::class, [
            'label' => 'nextstore_sylius_gift_card.form.gift_card_configuration.background_image',
            'required' => false,
            'remove_type' => true,
        ]);
        $builder->add('channelConfigurations', CollectionType::class, [
            'required' => false,
            'label' => 'nextstore_sylius_gift_card.form.gift_card_configuration.channel_configurations',
        ...
        $builder->add('defaultValidityPeriod', DatePeriodType::class, [
            'label' => 'nextstore_sylius_gift_card.form.gift_card_configuration.default_validity_period',
        ]);
        $builder->add('pageSize', ChoiceType::class, [
            'choices' => $this->availablePageSizes,
            'preferred_choices' => $this->preferredPageSizes,
            'label' => 'nextstore_sylius_gift_card.form.gift_card_configuration.page_size',
        ...
        $builder->add('orientation', ChoiceType::class, [
            ...
            'label' => 'nextstore_sylius_gift_card.form.gift_card_configuration.orientation',
            'choice_translation_domain' => false,
            'choice_label' => function (string $value) {
                return $value;
            },
        ...
        $builder->add('template', TextareaType::class, [
            'label' => 'nextstore_sylius_gift_card.form.gift_card_configuration.template',
        ]);
    ...
    {
        return 'nextstore_sylius_gift_card_gift_card_configuration';
    }
}

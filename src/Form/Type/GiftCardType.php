...
final class GiftCardType extends AbstractResourceType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->addEventListener(FormEvents::PRE_SET_DATA, function (FormEvent $event): void {
            ...
            $form->add('sendNotificationEmail', CheckboxType::class, [
                'required' => false,
                'label' => 'nextstore_sylius_gift_card.form.gift_card.send_notification_email',
            ]);
        });
        ...
        $builder->add('customMessage', TextareaType::class, [
            'label' => 'nextstore_sylius_gift_card.form.gift_card.custom_message',
            'required' => false,
            'attr' => [
                'placeholder' => 'nextstore_sylius_gift_card.form.gift_card.custom_message_placeholder',
            ],
        ]);
        $builder->add('expiresAt', DateTimeType::class, [
            'label' => 'nextstore_sylius_gift_card.form.gift_card.expires_at',
            'widget' => 'single_text',
            'html5' => true,
        ]);
        $builder->addEventListener(FormEvents::PRE_SET_DATA, function (FormEvent $event): void {
    ...
    {
        return 'nextstore_sylius_gift_card_gift_card';
    }
}

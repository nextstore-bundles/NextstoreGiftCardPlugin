...
trait OrderTrait
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="Nextstore\SyliusGiftCardPlugin\Model\GiftCardInterface", inversedBy="appliedOrders")
     *
     * @ORM\JoinTable(name="nextstore_sylius_gift_card__order_gift_cards",

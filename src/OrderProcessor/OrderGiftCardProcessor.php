...
namespace Nextstore\SyliusGiftCardPlugin\OrderProcessor;

use Nextstore\SyliusGiftCardPlugin\Model\AdjustmentInterface;
use Nextstore\SyliusGiftCardPlugin\Model\OrderInterface;
use Nextstore\SyliusGiftCardPlugin\Provider\OrderEligibleTotalProviderInterface;
    ...
    public function process(BaseOrderInterface $order): void
    {
        ...
        foreach ($order->getGiftCards() as $giftCard) {
            ...
            $adjustment = $this->adjustmentFactory->createWithData(
                ...
                $this->translator->trans('nextstore_sylius_gift_card.ui.gift_card'),
                -1 * $amount,
            );
